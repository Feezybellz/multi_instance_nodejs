module.exports = {
  apps: [
    ...
    {
      name: "api-server-test", // ✅ Unique name for development
      script: "./app/api-server.js",
      instances: 2,
      exec_mode: "cluster",
      ...
      log_date_format: "YYYY-MM-DD HH:mm Z",
      error_file: "./logs/api-error-test.log",
      out_file: "./logs/api-output-test.log",
      merge_logs: true,
    },
    ...
    {
      name: "websocket-server-test", // ✅ Unique name for development
      script: "./app/websocket-server.js",
      instances: 2,
      exec_mode: "cluster",
      watch: process.env.NODE_ENV === "test",
      ...
      log_date_format: "YYYY-MM-DD HH:mm Z",
      error_file: "./logs/ws-error-test.log",
      out_file: "./logs/ws-output-test.log",
      merge_logs: true,
    },
